...
| <img src="tools/record-meeting/icons/record-meeting.png" width="220"><br>[record-meeting](tools/record-meeting/README.md) | Mac - GUI | Always-on-top meeting recorder with system audio + microphone capture, MP3 export, speaker-labelled transcription, and Notion publishing |
