...
| <img src="tools/taskbar/docs/header.png" width="220"><br>[taskbar](tools/taskbar/README.md) | Mac - taskbar | Windows-style taskbar for macOS with one bar per monitor, pinned apps, per-monitor overrides, and window avoidance |
