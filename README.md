...
| <img src="tools/unmultitrack/icons/film.png" width="32"><br>[unmultitrack](tools/unmultitrack/README.md) | CLI + context menu | Extract every video stream from an OBS/Aitum multi-track recording into separate editor-friendly files; right-click any video file in Explorer |
